...
tidy2.txt -- the ouput of this assignement
...
5. Creates a second, independent tidy data set with the average of each ariable for each activity and each subject.

It should run in a folder of the  data (the zip had this folder: UCI HAR Dataset) The script assumes it has in it's working directory the following files and folders:
